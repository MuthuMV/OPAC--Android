...
public class BooksDisplayActivity extends Activity {
	      ...
	      adapter = new ArrayAdapter<String>(this, R.layout.list_item, R.id.product_name, items);
	        ...
	        inputSearch.addTextChangedListener(new TextWatcher() {	        	 
	             ...
	             public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
	        		 ...
	        		 ((ArrayAdapter<String>) BooksDisplayActivity.this.adapter).getFilter().filter(cs);
	             }
	        ...
	        listView.setOnItemClickListener(new OnItemClickListener()
	        {
	            ...
	            { 
	            	Intent resIntent = new Intent(BooksDisplayActivity.this,ReservationDisplayActivity.class);
		        	...
		        	BooksDisplayActivity.this.startActivity(resIntent);
	            }
	        });
