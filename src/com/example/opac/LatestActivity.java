...
public class LatestActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView =  (ListView) findViewById(R.id.latest_list);
		listView.setTextFilterEnabled(true);
		inputSearch = (EditText) findViewById(R.id.latest_Search);
		//httppost
		try{
			httpclient = new DefaultHttpClient();
			httppost = new HttpPost("http://192.168.137.1:80/latest.php");
		...
		try{
	        ...
	        JSONArray jArray = new JSONArray(result_latest);			
	      ...
	      adapter = new ArrayAdapter<String>(this, R.layout.list_item, R.id.product_name, items);
	        ...
	        inputSearch.addTextChangedListener(new TextWatcher() {	        	 
	             ...
	             public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
	        		 ...
	        		 ((ArrayAdapter<String>) LatestActivity.this.adapter).getFilter().filter(cs);
	             }
	        ...
	        listView.setOnItemClickListener(new OnItemClickListener()
	        {
	            ...
	            { 
	            	...
	            	Intent resIntent = new Intent(LatestActivity.this,ReservationDisplayActivity.class);
		        	...
		        	LatestActivity.this.startActivity(resIntent);
	            }
	        });
